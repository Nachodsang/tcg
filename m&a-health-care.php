    ...
    <div class="row">
     <div class="col-lg-6 p-0">
      <div  style="transform: translateX(20px); background-color:rgba(219,126,55,0.4)" class="image hover-effect  rounded-circle img-container shadow">
       <img style="transform: translateX(-20px) ;" alt="" src="images/doctor1.jpg" class="rounded-circle  img-fluid equalheight">
     </div>
   </div>
    ...
    <div class="split-box  center-block container-padding equalheight">
     <div class="heading-title padding">
       <div class="col-md-12 heading-section">
        ...
        <p class="mb-4">At the forefront of healthcare innovation and investment, Anonymous Healthcare Innovations offers a compelling opportunity for companies seeking financial support and strategic guidance:</p>
        <ol>
            <li>Investment in Cutting-Edge Technologies:
                <ul>
                    <li>Financial support for companies developing breakthrough medical technologies.</li>
                    <li>Access to our network of industry experts and resources to accelerate product development.</li>
                   
                </ul>
            </li>
            <li>Growth Catalyst for Startups:
                <ul>
                    <li>A commitment to fostering innovation in healthcare startups.</li>
                    <li>Mentorship programs and collaborative initiatives to nurture emerging talents.</li>
            ...
            <li>Strategic Partnerships for Market Expansion:
                  <ul>
                    ...
                    <li>Collaboration opportunities to leverage synergies for mutual growth.</li>
                   
                </ul>
            </li>
        </ol>
        <h3 class="mb-2">The Opportunity:</h3>
        <p class="mb-4">This is more than an investment; it's an opportunity to be part of a strategic alliance that shapes the future of healthcare. By partnering with Anonymous Healthcare Innovations, your company gains not just capital, but a supportive ally committed to advancing healthcare solutions.</p>
        <h3 class="mb-2">Next Steps:</h3>
        <p class="mb-4">For confidential discussions and to explore the potential of an investment partnership with Anonymous Healthcare Innovations, please contact our Consultant or send us an <a href="contact.php">inquiry</a>.</p>
