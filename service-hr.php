    ...
    <div class="row no-gutters slider-text align-items-end">
      <div class="col-md-9 ce-animate pb-5">
        <p class="breadcrumbs mb-2"><span class="mr-2"><a href="index.php">Home <span class="icon material-symbols-outlined">
          arrow_forward_ios
        </span></a></span> <span>Human Resources</span></p>
        <h1 class="mb-0 bread">Human Resources</h1>
      </div>
    </div>
  </div>
</section>
      ...
      <div class="container article">
        <div class="row justify-content-center align-items-stretch">
          ...
          <article class="col-lg-8 order-lg-2 px-lg-5 ce-animate">
            ...
            <img src="images/social1.jpg" alt="Image" class="img-fluid rounded">

            <h3>HR Consultants in Thailand</h3>
            <p>One of the main issues that companies face in their organizational development is recruitment and education of new employees. Personnel training strategies, such as on-the-job training and business manner education, can be achieved through thorough knowledge and accumulated experience of HR Consultants in Thailand.</p>

            <p>Associate, as a well-known HR Consultants in Thailand, provides original training services that aim to create professional leaders and capable managers – thus providing the necessary human resource services in  Thailand for prospective businesses.</p>
            <p>At associate, the philosophy is that the growth of employees is the corporate growth. In offering Human resource services in Thailand, we provide not just advice, but constant support to be put into practice daily.</p>


            <h3>HUMAN RESOURCE MANAGEMENT IN THAILAND</h3>
            <p>Recruitment regulations differ for every country. Based on our customers’ management philosophy and vision, associate seeks the most effective and controllable way for the organization to achieve its goals. Ability to follow recruitment regulations reflects the company’s reliability when hiring employees, which in turn affects the quality of human resources. Even in the middle of the development phase, reviews of recruitment regulations have a positive impact on customers’ needs for human resource services in Thailand. As the number of employees increases, the business scale grows, so setting ideal and balanced working hours and salaries become increasingly important for the future growth of the company.</p>
            <p>At associate, we believe that a proper employment agreement, in accordance with the culture and regulations of a company, is significant to minimize future conflicts between employers and employees. If both parties are considered fairly, the mutual agreement between employers and employees leads to satisfaction on both sides, consequently strengthening the organizational capacity of the company. It is therefore an integral part of our philosophy to strive to provide excellent human resource management services to our customers in Thailand.</p>
            ...
            <div class="pt-5 categories_tags ">
              <p>Tags: <a href="#">#hrconsultant</a>, <a href="#">#thailand</a></p>
            </div>

            <div class="post-single-navigation d-flex align-items-stretch">
              <a href="service-payroll.php" class="mr-2 w-50 pr-4">
                <span class="d-block"><span class="material-symbols-outlined">
                  arrow_back_ios
                </span> Previous Service</span>
               Payroll Services
              </a>
              <a href="service-social-insurance.php" class="ml-2 w-50 text-right pl-4">
