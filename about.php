   ...
   <div class="container-fluid">
    <div class="row">
     <div class="col-lg-6 p-0">
      <div  style="transform: translateX(20px); background: #233E59;" class="image hover-effect  rounded-circle img-container shadow">
       <img style="transform: translateX(-20px);" alt="" src="images/about-us.jpg" class="rounded-circle  img-fluid equalheight">
     </div>
   </div>
...
We can support one-stop service – accounting, taxation, labor and legal affairs.
        ...
        <p class="mb-4">We always provide you up-to-date information by “Wiki-Investment”, the data base of foreign direct investment.
    ...
    <div class="row mb-4">
      ...
      <div class="col-lg-4">
        <div class="box card-about" data-aos="zoom-in" data-aos-delay="100">
          ...
          <p>We learn throughout our entire life, so persistent effort is very important. No one should be satisfied with what he or she has. Our business environment is ever-changing, and if we cannot cope with such changes, it is time for us to retire as specialists.</p>
        </div>
      </div>
      ...
      <div class="col-lg-4 mt-4 mt-lg-0">
        <div class="box card-about" data-aos="zoom-in" data-aos-delay="200">
          ...
          <p>The reason why clients ask questions is because they want immediate advice. We must answer the clients’ questions right then and there. For that, it is important to be sufficiently prepared.</p>
        </div>
      </div>
      ...
      <div class="col-lg-4 mt-4 mt-lg-0">
        <div class="box card-about" data-aos="zoom-in" data-aos-delay="300">
          ...
          <p>When people take a long time to make a decision, it means that they are perplexed. It often happens that people take wrong decisions at such times. The appropriateness of a decision is not proportional to the time taken to take said decision. It is very important to take decisions immediately.</p>
        </div>
      </div>
    ...
    <div class="row mb-4">
      ...
      <div class="col-lg-4 mt-4 mt-lg-0">
        <div class="box card-about" data-aos="zoom-in" data-aos-delay="300">
          ...
          <p>We cannot get rewards from work that has no added value. We should take high rewards by giving high added value to our clients. The final evaluation from clients is the reward we get. No matter how well we think we’ve done our job, if we do not get rewards from clients, it means that we could not meet their needs and it becomes nothing more than self-satisfaction.
    ...
    <div class="row mb-4">
      ...
      <div class="col-lg-4">
        <div class="box card-about" data-aos="zoom-in" data-aos-delay="100">
          ...
          <p>It is very important to find delight at work. If we cannot find delight, be it in any difficult job, it is just a waste of time, and we end up getting nothing. A person with lots of complaints is definitely not able to do his or her job properly. Among successful people, there are not many who complain. This is because, upon facing difficulty, a successful person immediately thinks of a solution to the problem, instead of complaining.</p>
        </div>
      </div>
      ...
      <div class="col-lg-4 mt-4 mt-lg-0">
        <div class="box card-about" data-aos="zoom-in" data-aos-delay="200">
          ...
          <p>We must be able to analyze our knowledge and level of competency objectively. Further, we should always give 120% at work, compared to the present. We cannot get anything if we work from within the limits of our knowledge and ability. We should objectively analyze whether our present job will help developing our ability further, and must plan out ways to develop our ability.</p>
        </div>
      </div>
     ...
     <div class="row mb-4">
      ...
      <div class="col-lg-4">
        <div class="box card-about" data-aos="zoom-in" data-aos-delay="100">
          ...
          <p>Can we clearly define what we are working for, and what motives we are living with? People ultimately live either for themselves or for others. People who have the belief, philosophy, and will to live their lives for the sake of others (clients and society) can be said to be the real professionals.</p>
        </div>
      </div>
