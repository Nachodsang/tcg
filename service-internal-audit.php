    ...
    <div class="row no-gutters slider-text align-items-end">
      <div class="col-md-9 ce-animate pb-5">
        <p class="breadcrumbs mb-2"><span class="mr-2"><a href="index.php">Home <span class="icon material-symbols-outlined">
          arrow_forward_ios
        </span></a></span> <span>Internal Audit</span></p>
        <h1 class="mb-0 bread">Internal Audit</h1>
      </div>
    </div>
  </div>
</section>
      ...
      <div class="container article">
        <div class="row justify-content-center align-items-stretch">
          ...
          <article class="col-lg-8 order-lg-2 px-lg-5 ce-animate">
            ...
            <img src="images/service.jpg" alt="Image" class="img-fluid rounded">

            <h3>Auditing & Assurance in Thailand</h3>
            <p>Auditing & Assurance in Thailand: Internal controls are a crucial aspect of every corporation to maintain stability, reliability, and to prevent any suspicious activities. Hence, it is necessary for a company to have a reliable, independent entity to constantly analyze its operations, and proactively seek to maintain the company’s integrity. One of the most efficient ways to insure a company against such risks is to perform regular internal audits.</p>
            <p>Recently, there have been numerous cases of financial incidents involving foreign subsidiaries in Thailand One of the main causes of these issues is inefficient work at the foreign subsidiary, due to lack of monitoring from the parent company. If audit is performed directly at the subsidiary, the company has to dedicate much time and effort – and therefore cost – to do so. In addition, the company may not originally know the customs and regulations specific to thailand leading to even more difficulties.</p>
            <p>Associate staff have reliable professional and educational backgrounds, with high experience in internal auditing, specifically tailored to the authorized system. Our staff comprises Certified Internal Auditors and Certified Public Accountants, which allows us to perform constant, rigorous controls at our customers’ companies via internal audit in Thailand  Furthermore, by performing Auditing & Assurance in Thailand for our clients, we enhance the governance process and levels of control of the company over its operations. This ability is constantly demonstrated in the improvement of our clients’ operational organization and risk-management effectiveness.</p>
            <p>With the help of professionals, our clients are offered expert service for internal audit in  Thailand</p>
            ...
            <div class="pt-5 categories_tags ">
              <p>Tags: <a href="#">#internalaudit</a>, <a href="#">#thailand</a></p>
            </div>

            <div class="post-single-navigation d-flex align-items-stretch">
              <a href="service-accounting-service.php" class="mr-2 w-50 pr-4">
                <span class="d-block"><span class="material-symbols-outlined">
                  arrow_back_ios
                </span> Previous Service</span>
               Accounting Services
              </a>
              <a href="service-financial-audit.php" class="ml-2 w-50 text-right pl-4">
