      ...
      <div class="container article">
        <div class="row justify-content-center align-items-stretch">
          ...
          <article class="col-lg-8 order-lg-2 px-lg-5 ce-animate">
            ...
            <img src="images/blog-05.jpg" alt="Image" class="img-fluid rounded">
                    ...
                    <div class="carousel-gallery owl-carousel ftco-owl">
                      <div class="item">
                        <div class="testimony-wrap py-4">
                          <img src="images/image-default.jpg" class="img-fluid">
                        </div>
                      </div>
                      <div class="item">
                        <div class="testimony-wrap py-4">
            ...
            <div class="post-single-navigation d-flex align-items-stretch">
              ...
              <a href="#" class="ml-2 w-50 text-right pl-4">
                <span class="d-block">Next Post <span class="material-symbols-outlined">
                  arrow_forward_ios
                </span></span>
